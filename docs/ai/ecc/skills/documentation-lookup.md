...
**UTC eLibrary:** dùng cho **Laravel 12**, **Inertia v2**, **Vue 3**, **Maatwebsite/PhpSpreadsheet** (import/export Excel), **JWT** — gọi Context7 khi đã bật MCP; không thì đọc docs chính thức / code repo.
