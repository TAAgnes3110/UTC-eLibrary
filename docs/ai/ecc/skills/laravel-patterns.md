...
**UTC eLibrary:** API JSON qua `App\Helpers\ApiResponse`; auth **JWT** + middleware `init` và `role_or_permission` (Spatie). Bỏ qua ví dụ Sanctum trong tài liệu trừ khi task đổi stack.
