        ...
        <div class="font-sans w-full flex flex-col items-center">
            ...
            >
                <div class="px-5 py-6 sm:px-8">
                    ...
                    <p
                        class="text-center text-[13px] text-slate-500 mb-6 leading-relaxed"
                    >
                        Nhập email đăng ký tài khoản của bạn. Hệ thống sẽ gửi mã
                        xác thực OTP để quyền đặt lại mật khẩu.
                    </p>
