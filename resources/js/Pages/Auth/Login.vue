        ...
        <div class="font-sans w-full flex flex-col items-center">
            ...
            >
                <div class="px-5 py-6 sm:px-8">
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            >
                                ...
                                />
                                <div
                                    class="w-5 h-5 rounded-md border-2 border-white/10 bg-white/5 flex items-center justify-center transition-all group-hover:border-blue-500/50"
                                    :class="{
                                        'bg-blue-600 border-blue-600 shadow-[0_0_10px_rgba(59,130,246,0.5)]':
                                            form.remember,
                                    }"
                                >
                                    <svg
                                ...
                                <span
                                    class="text-xs font-bold text-slate-500 group-hover:text-slate-400 transition-colors uppercase tracking-wider"
                                    >Ghi nhớ</span
                                >
                            </label>
                            <Link
                    ...
                    <!-- Register Link -->
                    <div
                        class="text-center mt-4 pt-4 border-t border-white/10 space-y-2"
                    >
                        <div
                            class="p-3.5 rounded-xl bg-blue-500/5 border border-blue-500/10 space-y-2 shadow-inner"
                        >
                            <p
                                class="text-[10px] text-slate-400 font-bold uppercase tracking-widest leading-none"
                            >
                            ...
                            >
                                <span
                                    class="leading-none uppercase tracking-widest"
