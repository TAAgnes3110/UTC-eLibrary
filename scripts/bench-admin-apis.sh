...
echo "Benchmark admin APIs | runs=${RUNS} | base_url=${BASE_URL}"
bench_endpoint "users" "/api/v1/users?per_page=20&page=1"
bench_endpoint "news-posts" "/api/v1/news-posts?per_page=20&page=1&sort=newest"
bench_endpoint "library-cards" "/api/v1/library-cards?per_page=20&page=1&management=1&sort_by=newest"
