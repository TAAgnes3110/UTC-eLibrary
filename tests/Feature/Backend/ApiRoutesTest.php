...
class ApiRoutesTest extends TestCase
{
    ...
    public static function protectedRoutesProvider(): array
    {
        ...
        return [
            ...
            'storage-cabinets store slot' => ['POST', "{$base}/storage-cabinets/1/slots", [], [401, 404]],
            'storage-cabinets update slot' => ['PUT', "{$base}/storage-cabinets/1/slots/1", ['slot_name' => 'x'], [401, 404, 422]],
            'storage-cabinets delete slot' => ['DELETE', "{$base}/storage-cabinets/1/slots/1", [], [401, 404, 422]],
            'storage-slots index' => ['GET', "{$base}/storage-slots"],
